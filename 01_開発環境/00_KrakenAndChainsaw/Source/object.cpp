...
void CObject::DeleteAll(void)
{
	...
	for (int nCntPri = 0; nCntPri < PRIORITY_MAX; nCntPri++)
	{
		...
		while (pObject != nullptr)
		{
			...
			{
				// 先頭がなくなる場合
				if (pObject->m_pPrev == nullptr && pObject->m_pNext != nullptr)
				{
