...
//**************************************************
float my_vector::VectorAngleToRadian(D3DXVECTOR3 vecA, D3DXVECTOR3 vecB)
{
	// ベクトルを正規化
...
// ベクトルのなす角を求める処理(ラジアン角)
//**************************************************
float my_vector::VectorsAngle2D(D3DXVECTOR2 vecA, D3DXVECTOR2 vecB)
{
...
// ポリゴンの押し出し処理(滑らない)
//**************************************************
float my_vector::ExtrusionPolygonNoSlip(D3DXVECTOR3* pOut, D3DXVECTOR3 posPolygon, D3DXVECTOR3 nor, D3DXVECTOR3 posPush)
{
	// 法線とポリゴンの一頂点の内積
...
// ポリゴンの押し出し処理(滑る)
//**************************************************
D3DXVECTOR3 my_vector::ExtrusionPolygonSlide(D3DXVECTOR3* pOut, D3DXVECTOR3 posPolygon, D3DXVECTOR3 nor, D3DXVECTOR3 posPush)
{
...
// 角度の正規化
//************************************************************************************************************************
float my_vector::AngleNormalize(const float fAngle)
{
...
// 角度の正規化
//************************************************************************************************************************
D3DXVECTOR3 my_vector::AngleNormalize(const D3DXVECTOR3 angle)
{
	D3DXVECTOR3 angleN;
...
// ベクトルの角度算出
//************************************************************************************************************************
float my_vector::AngleAtan2f(const D3DXVECTOR2 vecA, const D3DXVECTOR2 vecB)
{
...
// 最短の角度差を計算する処理
//**************************************************
float my_vector::AngleShortestDiff(float AngleDest, float Angle)
{
...
// ベクトルの正規化
//************************************************************************************************************************
D3DXVECTOR3 my_vector::Vec3Normalize(const D3DXVECTOR3 vec)
{
...
// 位置に回転マトリックスを掛ける処理
//**************************************************
D3DXVECTOR3 my_vector::Vec3MulMtx(const D3DXVECTOR3 pos, const D3DXMATRIX mtx)
{
	D3DXVECTOR3 posOut;
...
// 位置に回転マトリックスだけを掛ける処理
//**************************************************
D3DXVECTOR3 my_vector::Vec3MulMtxRotat(const D3DXVECTOR3 pos, const D3DXMATRIX mtx)
{
	D3DXVECTOR3 posOut;
...
// ベクトルの内積
//**************************************************
float my_vector::Vec3Dot(const D3DXVECTOR3 vecA, const D3DXVECTOR3 vecB)
{
...
// ベクトルの外積
//**************************************************
D3DXVECTOR3 my_vector::Vec3Cross(const D3DXVECTOR3 vecA, const D3DXVECTOR3 vecB)
{
	D3DXVECTOR3 cross;
...
// ベクトルの長さ
//**************************************************
float my_vector::Vec3Length(const D3DXVECTOR3 vec)
{
...
// ベクトル同士の角度を求める処理
//**************************************************
float my_vector::AngleVec3AndVec3(const D3DXVECTOR3 vecA, const  D3DXVECTOR3 vecB)
{
	// ベクトルを正規化
...
// ベクトルの線形補間
//**************************************************
D3DXVECTOR3 my_vector::Vec3Lerp(const D3DXVECTOR3 vecA, const  D3DXVECTOR3 vecB, const float fPalam)
{
	// 計算用変数
	D3DXVECTOR3 vecLeap,vecDiff;

	// ベクトルの差分を求める
	vecDiff = vecB - vecA;

	// 倍率を掛けて値を求める
	vecLeap.x = vecA.x + vecDiff.x * fPalam;
	vecLeap.y = vecA.y + vecDiff.y * fPalam;
	vecLeap.z = vecA.z + vecDiff.z * fPalam;
	return vecLeap;
}