...
// 
//****************************************************
#ifndef _COMPONENT_COLLISIONMODEL_H_
#define _COMPONENT_COLLISIONMODEL_H_

#include "component.h"
#include "bone.h"

// パーツクラス
class CCollisionModel : public CComponent
{
public:
	CCollisionModel();
	CCollisionModel(const int nIdxBone, const D3DXVECTOR3 pos, const D3DXQUATERNION quat, const std::string& XFilePath);
	~CCollisionModel();
	...
	static void SwitchDisp(void) { m_bDisp = !m_bDisp; }
